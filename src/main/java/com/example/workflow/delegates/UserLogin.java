...
@Named
@Component
public class UserLogin implements JavaDelegate {


    private final ActorService actorService;
    private final JwtTokenProvider jwtTokenProvider;

    public UserLogin(ActorService actorService, JwtTokenProvider jwtTokenProvider) {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        try {
            ...
            if (!actor.getRole().equals(Role.USER)) throw new IllegalAccessException("У вас нет прав на этот процесс");
