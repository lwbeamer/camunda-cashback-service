...
@Named
@Component
public class AcquireLogin implements JavaDelegate {


    private final ActorService actorService;
    private final JwtTokenProvider jwtTokenProvider;

    public AcquireLogin(ActorService actorService, JwtTokenProvider jwtTokenProvider) {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        try {
            ...
            if (!actor.getRole().equals(Role.ACQUIRE)) throw new IllegalAccessException("У вас нет прав на этот процесс");
